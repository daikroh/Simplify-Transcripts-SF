...
def main():
    merge_transcript_and_summary(
        "agendas_with_transcripts.csv", "agendas_with_summary.csv", "merged_1.csv"
    )
    merge_transcript_and_summary(
        "agendas_with_transcripts_meeting2.csv",
        "agendas_with_summary_meeting2.csv",
        "merged_2.csv",
    )
